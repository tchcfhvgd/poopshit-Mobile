...
class DiscordClient
{
	...
	private static var _defaultID:String = "1131299025451241533";
	...
	private static var _options:Dynamic = {
		...
		state: null,
		largeImageKey: 'icon',
		largeImageText: "Im Shitting My Pants",
		smallImageKey : null,
		startTimestamp : null,
		endTimestamp : null
	};
	...
	public static function changePresence(details:String, state:Null<String>, ?smallImageKey : String, ?hasStartTimestamp : Bool, ?endTimestamp: Float)
	{
		...
		_options.largeImageKey = smallImageKey;
		_options.largeImageText = "Im Shitting My Pants";
		_options.smallImageKey = (smallImageKey == 'icon' ? '' : 'icon');
