...
class MusicBeatState extends FlxUIState
{
	...
	public static var doTransition:Bool = false;
	public static var whatTransition:String = "";
	...
	override function create() {
		...
		if(doTransition) openSubState(new Transition(true, whatTransition));
		doTransition = false;
		whatTransition = "";
		timePassedOnState = 0;
	}
	...
	public static function switchState(nextState:FlxState = null) {
		...
		if(!doTransition) FlxG.switchState(nextState);
		else startTransition(nextState);
	}

	public static function resetState() {
		if(!doTransition) FlxG.resetState();
	...
	public static function startTransition(nextState:FlxState = null) {
		if(nextState == null) nextState = FlxG.state;
		FlxG.state.openSubState(new Transition(false, whatTransition));

		if(nextState == FlxG.state) Transition.finishCallback = function() FlxG.resetState();
		else Transition.finishCallback = function() FlxG.switchState(nextState);
	}
