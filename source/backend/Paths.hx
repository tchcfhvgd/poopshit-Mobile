...
class Paths
{
	...
	public static var dumpExclusions:Array<String> = [
		'assets/music/PoopshittersMainMenu.$SOUND_EXT',
		'assets/music/PapyrusEXEFreeplay.$SOUND_EXT',
		'assets/music/Some Time Ago.$SOUND_EXT',
	...
	{
		#if html5
		return 'songs:assets/songs/${formatToSongPath(song)}/PVoices.$SOUND_EXT';
		#else
	...
	{
		#if html5
		return 'songs:assets/songs/${formatToSongPath(song)}/OVoices.$SOUND_EXT';
		#else
	...
	inline static public function pauseMusic(song:String):Any
	{
		#if html5
		return 'songs:assets/songs/${formatToSongPath(song)}/Pause.$SOUND_EXT';
		#else
		var songKey:String = '${formatToSongPath(song)}/Pause';
		var pause = returnSound('songs', songKey);
		return pause;
		#end
	}
