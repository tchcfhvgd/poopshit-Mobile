...
class Controls
{
	...
	public var OVERWORLD_UP_P(get, never):Bool;
	public var OVERWORLD_DOWN_P(get, never):Bool;
	public var OVERWORLD_LEFT_P(get, never):Bool;
	public var OVERWORLD_RIGHT_P(get, never):Bool;
	...
	private function get_OVERWORLD_UP_P() return justPressed('overworld_up');
	private function get_OVERWORLD_DOWN_P() return justPressed('overworld_down');
	private function get_OVERWORLD_LEFT_P() return justPressed('overworld_left');
	private function get_OVERWORLD_RIGHT_P() return justPressed('overworld_right');
	...
	public var OVERWORLD_UP(get, never):Bool;
	public var OVERWORLD_DOWN(get, never):Bool;
	public var OVERWORLD_LEFT(get, never):Bool;
	public var OVERWORLD_RIGHT(get, never):Bool;
	...
	private function get_OVERWORLD_UP() return pressed('overworld_up');
	private function get_OVERWORLD_DOWN() return pressed('overworld_down');
	private function get_OVERWORLD_LEFT() return pressed('overworld_left');
	private function get_OVERWORLD_RIGHT() return pressed('overworld_right');
	...
	public var OVERWORLD_UP_R(get, never):Bool;
	public var OVERWORLD_DOWN_R(get, never):Bool;
	public var OVERWORLD_LEFT_R(get, never):Bool;
	public var OVERWORLD_RIGHT_R(get, never):Bool;
	...
	private function get_OVERWORLD_UP_R() return justReleased('overworld_up');
	private function get_OVERWORLD_DOWN_R() return justReleased('overworld_down');
	private function get_OVERWORLD_LEFT_R() return justReleased('overworld_left');
	private function get_OVERWORLD_RIGHT_R() return justReleased('overworld_right');


	// Pressed buttons (others)
	public var DIA_NEXT(get, never):Bool;
	public var DIA_SKIP(get, never):Bool;
	public var ACCEPT(get, never):Bool;
	public var BACK(get, never):Bool;
	public var MENU(get, never):Bool;
	public var PAUSE(get, never):Bool;
	public var RESET(get, never):Bool;
	private function get_DIA_NEXT() return justPressed('dia_next');
	private function get_DIA_SKIP() return justPressed('dia_skip');
	private function get_ACCEPT() return justPressed('accept');
	private function get_BACK() return justPressed('back');
	private function get_MENU() return justPressed('menu');
